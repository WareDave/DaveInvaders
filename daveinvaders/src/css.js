...
class Css extends Component {
  ...
  render() {
    ...
    <p></p>
    <code class='code'>
    ackground-position- Defines the origin of a background image.
    </code>
    ...
    <p></p>
    <code class='code'>
    clear- Specifies the placement of an element in relation to floating elements. ( clear: fix; )
    </code>
